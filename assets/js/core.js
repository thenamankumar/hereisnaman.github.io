  ...
  var Core = {
        ...
        $content.fullpage({
          ...
          onLeave: function(anchorLink, index) {
            Core.Basic.setSectionScheme(
              $content.find('.section').eq(index - 1),
            );
          },
        });
      },
        ...
        init: function() {
          ...
          if (pageScrolling) {
            ...
            $section.waypoint({
              ...
              offset: function() {
                if (navHorizontal)
                  return -this.element.clientHeight + navHeight;
    ...
    Component: {
          ...
          $ajaxTmp.load(target, function(response, status) {
            if (status == 'success') {
              ...
              $ajaxModal
                ...
                .addClass($targetContent.data('scheme'));
              ...
              $('.animated', $self).appear(function() {
                $(this).each(function() {
                  ...
                  setTimeout(function() {
                    $target
                      .addClass($target.data('animation'))
                      .addClass('visible');
                  }, delay);
                });
              });
      ...
      carousel: function($content) {
        ...
        $sectionSlides.on('beforeChange', function(
          event,
          slick,
          currentSlide,
          nextSlide,
      ...
      map: function() {
        ...
        if ($googleMap.length) {
          ...
          var mapMarker = $googleMap.data('marker')
        ...
        if ($window.length) {
          ...
          $windowToggle.on('click', function() {
            ...
            if (!$target.hasClass('show')) {
              ...
              el
                .stop()
                .animate({transform: 't0,0'}, 300, mina.linear, function() {
                  el.stop().animate(
                    {
                      path:
      ...
      contactMap: function() {
        $('[data-toggle="contact-map"]', '#content').on('change', function(e) {
          var $self = $(this),
            ...
            $sectionContactContent = $sectionContact.find(
